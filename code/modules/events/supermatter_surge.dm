...
/datum/round_event/supermatter_surge/announce(fake)
	...
	priority_announce("Система контроля целостности кристаллов обнаружила необычные свойства атмосферы в камере Суперматерии, выход энергии из кристалла Суперматерии значительно увеличился. Требуется инженерное вмешательство для стабилизации работы кристала.", "ВНИМАНИЕ: АНОМАЛИЯ", SSstation.announcer.event_sounds[ANNOUNCER_SUPERMATTER_SURGE] || 'sound/machines/engine_alert/engine_alert3.ogg') // SPLURT EDIT - ORIGINAL: priority_announce("The Crystal Integrity Monitoring System has detected unusual atmospheric properties in the supermatter chamber, energy output from the supermatter crystal has increased significantly. Engineering intervention is required to stabilize the engine.", "Class [class_to_announce] Supermatter Surge Alert", 'sound/machines/engine_alert/engine_alert3.ogg')
